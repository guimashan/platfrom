    ...
    function createApplicantCard(name = '家人/親友', canRemove = true) {
        ...
        card.innerHTML = `
            ...
            <div class="applicant-details">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; padding: 18px 0; border-bottom: 1px solid #e0e0e0;">
                    <span style="font-size: 1.15rem; font-weight: 500;">安太歲</span>
                    <div style="display: flex; align-items: center; gap: 12px;">
                        <span style="font-size: 1rem;">數量：</span>
                        <input type="number" class="input-field light-count" data-light-name="安太歲" min="0" placeholder="0" style="width: 100px; height: 56px; font-size: 1.1rem; text-align: center;">
                    </div>
                </div>
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; padding: 18px 0; border-bottom: 1px solid #e0e0e0;">
                    ...
                    <div style="display: flex; align-items: center; gap: 12px;">
                        <span style="font-size: 1rem;">數量：</span>
                        <input type="number" class="input-field light-count" data-light-name="元辰燈" min="0" placeholder="0" style="width: 100px; height: 56px; font-size: 1.1rem; text-align: center;">
                    </div>
                </div>
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; padding: 18px 0; border-bottom: 1px solid #e0e0e0;">
                    ...
                    <div style="display: flex; align-items: center; gap: 12px;">
                        <span style="font-size: 1rem;">數量：</span>
                        <input type="number" class="input-field light-count" data-light-name="文昌燈" min="0" placeholder="0" style="width: 100px; height: 56px; font-size: 1.1rem; text-align: center;">
                    </div>
                </div>
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; padding: 18px 0; border-bottom: 1px solid #e0e0e0;">
                    ...
                    <div style="display: flex; align-items: center; gap: 12px;">
                        <span style="font-size: 1rem;">數量：</span>
                        <input type="number" class="input-field light-count" data-light-name="財利燈" min="0" placeholder="0" style="width: 100px; height: 56px; font-size: 1.1rem; text-align: center;">
                    </div>
                </div>
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; padding: 18px 0;">
                    ...
                    <div style="display: flex; align-items: center; gap: 12px;">
                        <span style="font-size: 1rem;">數量：</span>
                        <input type="number" class="input-field light-count" data-light-name="光明燈" min="0" placeholder="0" style="width: 100px; height: 56px; font-size: 1.1rem; text-align: center;">
                    </div>
                </div>

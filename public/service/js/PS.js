        ...
        <div class="applicant-details">
            ...
            <div class="form-group">
                <div style="display: flex; align-items: center; gap: 15px;">
                    ...
                    <input type="number" id="puzhuo-${cardId}" class="input-field donation-amount" value="0" min="0" step="1" placeholder="欄位" style="flex: 1;">
                </div>
            </div>
            ...
            <div class="form-group">
                <div style="display: flex; align-items: center; gap: 15px;">
                    ...
                    <input type="number" id="rice-${cardId}" class="input-field donation-amount" value="0" min="0" step="100" placeholder="欄位" style="flex: 1;">
                </div>
            </div>
            ...
            <div class="form-group">
                <div style="display: flex; align-items: center; gap: 15px;">
                    ...
                    <span style="color: #666; white-space: nowrap;">NT$</span>
                    <input type="number" id="donation-${cardId}" class="input-field donation-amount" value="0" min="0" step="100" placeholder="欄位" style="flex: 1;">
                </div>
            </div>

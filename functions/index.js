...
if (!PROJECT_ID || PROJECT_ID === 'checkin-76c77') {
  ...
  exports.getCheckinHistoryV3 = checkinFunctions.getCheckinHistoryV3;
...
if (!PROJECT_ID || PROJECT_ID === 'service-b9d4a') {
  ...
  exports.cleanupOldOrders = serviceFunctions.cleanupOldOrders;
  exports.getUserRegistrations = serviceFunctions.getUserRegistrations;
}
